...
# Feriados de 2023
jsonlite::fromJSON('https://apis.digital.gob.cl/fl/feriados/2023') |> head()
jsonlite::fromJSON(paste0(url,'/', 2023)) |> head()

# Ahora capturemos los feriados de 2021 a 2023
anios <- 2020:2023
...
feriados_nombres_chr <- map(feriados_nombres, \(x) discard(x, \(y) y == ''))

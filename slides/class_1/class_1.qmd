...
-   Acceder a repositorio de Github para acceder a material de clases y ejercicios.
    -   [Repositorio del curso](https://github.com/caayala/web_scraping_soc40XX_2023)
...
Si ya han _copiado--&--pegado_ información de la web a un archivo, guardado imágenes o sonidos manualmente, ya hicieron web scraping.
...
-   Considerar **aspectos [éticos](https://www.imdb.com/robots.txt)** y legales.
:::
:::
...
2.  Localizar las **URLs** en donde esté la información que querramos extraer.
...
-   `javascript`: faculta a que una página web contenga y ejecuteprogramas ([¡wordle!](https://www.nytimes.com/games/wordle/index.html)).
